...
if __name__ == "__main__":
    ...
    response = api.get_players(postleitzahl=66123)

    # Print the response.
    for idx, actor in enumerate(response["Marktakteure"]):
        nummer = actor.get("MarktakteurMastrNummer", "N/A")
        rolle = actor.get("Marktfunktion", "N/A")
        reg_date = actor.get("RegistrierungsdatumMarktakteur", "N/A")
        print(f"#{idx:002d} {nummer} - {rolle} - {reg_date}")
